<?php $__env->startSection('title', 'Registro - Biblioteca Virtual'); ?>
...
unset($__errorArgs, $__bag); ?>" id="role" name="role" required>
                                    ...
                                    <option value="usuario" <?php echo e(old('role') == 'usuario' ? 'selected' : ''); ?>>
                                        Usuario - Puede solicitar préstamos
                                    </option>
                                    <option value="bibliotecario" <?php echo e(old('role') == 'bibliotecario' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-4">
                        <p class="mb-0">¿Ya tienes una cuenta?
                            <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Inicia sesión aquí</a>
                        </p>
                    </div>
                </div>
            </div>
